...
?>
                ...
                <div class="row">
                  ...
                  <?php
                  foreach($productos->getDestacados() as $producto){ //La función getDestacados() está en Productos.php.
                     echo $producto->getThumbnailHtml(); //La función getThumbnailHtml() está en Producto.php de ElCaminas.
                  }
                  ?>
                </div>
                <div class="row">
