...
<body>
  <div id="mask" style="position: fixed; width: 100%; height: 100%; top: 0px; left: 0px; z-index: 1040; background-color: white;  opacity: .9; display:none">
      <div class="alert alert-info" role="alert" style='position: absolute;  top: 35%;  left: 50%;  transform: translate(-30%, -50%);'>
          <img src='<?php echo CSSPATH;?>../include/loading.gif'>
      </div>
  </div>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./index.php">Alejandro Martín</a>
            </div>
